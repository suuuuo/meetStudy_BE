...
public class QuestionController {
  ...
  public ResponseEntity<List<ResponseQuestionDto>> getAllQuestions(
    ...
    return new ResponseEntity<>(questionService.getAllQuestionsByKeywords(keyword, page, size, category),
        HttpStatus.OK) ;
  }
  ...
  public ResponseEntity<ResponseQuestionDto> getQuestion(@PathVariable long questionId,
      @RequestParam(required = false) String password) throws AccessDeniedException {
  ...
  public ResponseEntity<ResponseQuestionDto> postQuestion(@Validated @RequestBody RequestQuestionDto requestQuestionDto) {
  ...
  public ResponseEntity<ResponseQuestionDto> updateQuestion(@RequestBody @Valid RequestQuestionDto requestQuestionDto,
      @PathVariable long questionId) throws AccessDeniedException {
    return new ResponseEntity<>(questionService.updateQuestion(requestQuestionDto, questionId),
        HttpStatus.OK);
  }
