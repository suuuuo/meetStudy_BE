...
public class CalendarController {
    ...
    public ResponseEntity<List<ResponseCalendarDetail>> getCalendarDetails(
        ...
        return new ResponseEntity<>(
            calendarDetailService.getAllCalendarDetail(year, month, 0L),
            HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseCalendarDetail> getCalendarDetail(@PathVariable long calendarDetailId) {
        return new ResponseEntity<>(
    ...
    public ResponseEntity<ResponseCalendarDetail> postCalendarDetail(
        ...
        return new ResponseEntity<>(
            calendarDetailService.saveCalendarDetail(requestCalendarDetail, 0L)
           ,HttpStatus.OK);
    }
